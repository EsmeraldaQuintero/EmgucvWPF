    ...
    public static class DrawMatches
    {
        ...
        public static Mat Draw(Mat modelImage, Mat observedImage, out long matchTime)
        {
            ...
            using (VectorOfVectorOfDMatch matches = new VectorOfVectorOfDMatch())
            {
                ...
                Mat result = new Mat();
                Mat debugMask = new Mat(mask.Rows, mask.Cols,DepthType.Default, mask.NumberOfChannels);
                VectorOfVectorOfDMatch debugMatch = new VectorOfVectorOfDMatch(matches.Size);
